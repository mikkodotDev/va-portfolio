import { FaGear, FaCode, FaBolt } from "react-icons/fa6";
import {
  FaShopify,
  FaWordpress,
  FaGoogle,
...
// ===== Image Imports =====
import architectFrontpage from "../assets/images/worpress_project_images/architect/Frontpage.jpg";
import architectGallery from "../assets/images/worpress_project_images/architect/1.png";
import etherealFrontpage from "../assets/images/worpress_project_images/ethereal/EtFrontpage.jpg";
import etherealGalleryOne from "../assets/images/worpress_project_images/ethereal/1.png";
import etherealGalleryTwo from "../assets/images/worpress_project_images/ethereal/2.png";
import etherealGalleryThree from "../assets/images/worpress_project_images/ethereal/3.png";
...
export const SERVICES = [
  ...
  },
  {
    ...
    tags: ["Elementor", "Spectra", "Gutenberg", "WooCommerce", "Custom Design"],
  },
  {
    icon: FaFigma,
    iconColor: "#f24e1e",
...
export const PORTFOLIO_PROJECTS = [
  {
    ...
    category: "E-Commerce",
    shortDescription:
      "Minimalist e-commerce platform for a fashion brand focused on curated collections, seasonal sales, and architectural precision in design.",
    clientNeeded: {
      problem:
        "The brand needed a modern e-commerce site that reflected their minimalist aesthetic and high-end positioning.",
      explanation:
        "Required clean product galleries, curated collections, seasonal sale sections, and a smooth checkout experience.",
    },
    howIHelped:
      "Built a WordPress + WooCommerce site with Elementor, featuring custom product layouts, collection filters, seasonal sale banners, and optimized mobile experience. Implemented clean typography and breathing room in design.",
    results: [
      { metric: "Clean", label: "Minimalist Design" },
      { metric: "Fast", label: "Optimized Performance" },
      { metric: "Responsive", label: "Mobile-First Build" },
    ],
    placeholder: architectFrontpage,
    galleryImages: [architectFrontpage, architectGallery],
  },
  {
    id: "ethereal",
    name: "Ethereal",
    ...
    category: "Fashion",
    shortDescription:
      "Luxury fashion e-commerce site with curated essentials, sustainability messaging, and refined product presentation.",
    clientNeeded: {
      problem:
        "A sustainable fashion brand needed a website that communicated their luxury positioning and commitment to quality.",
      explanation:
        "Needed elegant product photography, sustainability story sections, curated edit collections, and premium checkout flow.",
    },
    howIHelped:
      "Designed and built a sophisticated WordPress site using Elementor with premium product layout, hero sections with stunning imagery, sustainability messaging, and integrated blog for content marketing.",
    results: [
      { metric: "Luxury", label: "Premium Aesthetic" },
      { metric: "Storytelling", label: "Brand Messaging" },
      { metric: "Conversion", label: "Optimized CTAs" },
    ],
    placeholder: etherealFrontpage,
    galleryImages: [
      etherealFrontpage,
      etherealGalleryOne,
      etherealGalleryTwo,
      etherealGalleryThree,
    ],
  },
];
